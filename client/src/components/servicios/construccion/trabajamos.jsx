...
export default function Trabajamos({proporcional}) {

    const [seleccion_trabajo, setSeleccionTrabajo] = useState('')

    return (
         <div style={{width: '100%', height: 'auto', background: 'rgb(239, 126, 50)', paddingLeft: 320 / proporcional, paddingRight: 320 / proporcional}}>
