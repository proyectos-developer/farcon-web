...
export default function SliderConstruccionTablet({proporcional}) {
 
    return (
        <div style={{width: '100%', height: 600 / proporcional, backgroundImage: `url(${fondo_construccion})`, backgroundSize: 'cover', backgroundPosition: 'center', 
