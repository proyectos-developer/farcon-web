...
export default function TrabajamosCell({proporcional}) {

    const [seleccion_trabajo, setSeleccionTrabajo] = useState('')

    return (
         <div style={{width: '100%', height: 'auto', background: 'rgb(239, 126, 50)', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 60 / proporcional, paddingBottom: 60 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <img src={imagen_constructores} style={{width: 400 / proporcional, height: 560 / proporcional, marginTop: 40 / proporcional, marginBottom: 40 / proporcional}}/>
                    </div>
            </div>
        </div>
    )
