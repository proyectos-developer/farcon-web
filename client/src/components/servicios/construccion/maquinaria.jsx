...
export default function Maquinaria({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 54 / proporcional, paddingBottom: 54 / proporcional, paddingLeft: 320 / proporcional, paddingRight: 320 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    <div className={`${seleccion_equipo === 'equipo0' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '31%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
                    ...
                    <div className={`${seleccion_equipo === 'equipo1' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '31%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
                    ...
                    <div className={`${seleccion_equipo === 'equipo2' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '31%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
