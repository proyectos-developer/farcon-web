...
export default function QueHacemosCell({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 54 / proporcional, paddingBottom: 54 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '100%', height: 'auto', paddingTop: 27 / proporcional, paddingBottom: 27 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                        <div style={{width: '90%', height: 'auto'}}
                            onMouseOver={() => setSeleccionHacemos('hacemos_0')} onMouseLeave={() => setSeleccionHacemos('')}>
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                borderRadius: seleccion_hacemos === 'hacemos_0' ? 64 / proporcional : 8 / proporcional, cursor: 'pointer'}}>
                                <img src={hacemos_0} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_0' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                        <div style={{width: '90%', height: 'auto'}}
                            ...
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                ...
                                <img src={hacemos_1} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_1' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                            <div style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                                <p style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, fontWeight: 600, fontFamily: 'Poppins, serif',
                                        color: 'rgb(51, 51, 51)'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>   
                        <div style={{width: '90%', height: 'auto'}}
                            ...
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                ...
                                <img src={hacemos_2} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_2' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                            <div style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                                <p style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, fontWeight: 600, fontFamily: 'Poppins, serif',
                                        color: 'rgb(51, 51, 51)'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                        <div style={{width: '90%', height: 'auto'}}
                            ...
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                ...
                                <img src={hacemos_3} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_3' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                            <div style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                                <p style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, fontWeight: 600, fontFamily: 'Poppins, serif',
                                        color: 'rgb(51, 51, 51)'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                        <div style={{width: '90%', height: 'auto'}}
                            ...
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                ...
                                <img src={hacemos_4} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_4' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                            <div style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                                <p style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, fontWeight: 600, fontFamily: 'Poppins, serif',
                                        color: 'rgb(51, 51, 51)'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                        <div style={{width: '90%', height: 'auto'}}
                            ...
                            <div className='' style={{width: '90%', height: 'auto', border: '2px solid rgb(239, 126, 50)', marginBottom: 30 / proporcional,
                                ...
                                <img src={hacemos_5} style={{width: '100%', height: 250 / proporcional, borderRadius: seleccion_hacemos === 'hacemos_5' ? 64 / proporcional : 8 / proporcional}}/>
                            </div>
                            <div style={{width: '100%', height: 'auto', marginBottom: 34 / proporcional}}>
                                <p style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, fontWeight: 600, fontFamily: 'Poppins, serif',
                                        color: 'rgb(51, 51, 51)'}}>
