...
export default function MaquinariaCell({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 54 / proporcional, paddingBottom: 54 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <div className={`${seleccion_equipo === 'equipo0' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '90%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <div className={`${seleccion_equipo === 'equipo1' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '90%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>        
                    <div className={`${seleccion_equipo === 'equipo2' ? 'shadow-lg rounded' : 'shadow rounded'}`} style={{width: '90%', height: 'auto', border: '1ps solid 2px solid rgb(239, 126, 50)',
