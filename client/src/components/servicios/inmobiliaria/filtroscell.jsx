        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 24 / proporcional, marginTop: 24 / proporcional}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                        <div className='d-flex' style={{width: '90%', height: 24 / proporcional}}
            ...
            <div style={{width: '100%', height: 'auto', marginTop: 24 / proporcional}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-end' style={{width: '30%', height: 50 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div className='shadow rounded' style={{width: '90%', height: 'auto', border: '1px solid #efefef'}}>
