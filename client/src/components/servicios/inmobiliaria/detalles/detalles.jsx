...
export default function DetallesInmueble({proporcional}) {
                ...
                <div className='shadow rounded' style={{width: '100%', height: 'auto', background: 'white', padding: 20 / proporcional}}>
                    <div className='position-relative' style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                            <img src={imagen} style={{width: 690 / proporcional, height: 560 / proporcional}}/>
                        </div>
                    ...
                    <div style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional, marginTop: 40 / proporcional}}>
                        <div style={{width: '100%', height: 'auto'}}>
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 30 / proporcional}}>
                                <div style={{width: '40%', height: 30 / proporcional}}>
                                    <div className='d-flex justify-content-between' style={{width: '100%', height: 30 / proporcional}}>
                                ...
                                <div style={{width: '60%', height: 30 / proporcional}}>
                    ...
                    <div style={{width: '100%', height: 'auto', marginBottom: 48 / proporcional, paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                        ...
                        <div style={{width: '100%', height: 'auto'}}>
                            <div className='' style={{width: '100%', height: 150 / proporcional, marginBottom: 48 / proporcional}}>
                                <div className='d-flex' style={{width: '100%', height: 150 / proporcional}}>
                                    <div className='d-flex justify-content-center' style={{width: 180 / proporcional, height: 150 / proporcional}}>
                                        <img className='rounded-circle' src={cliente_coment_1} style={{width: 150 / proporcional, height: 150 / proporcional}}/>
                                    </div>
                                    <div style={{width: 'auto', height: 150 / proporcional, paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                                        <div style={{width: '100%', height: 'auto'}}>
                        ...
                        <div style={{width: '100%', height: 'auto'}}>
                            <div style={{width: '100%', height: 50 / proporcional, marginBottom: 16 / proporcional}}>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional}}>
                                   <input 
                                        style={{width: '48%', height: 50 / proporcional, fontSize: 16 / proporcional, lineHeight: `${48 / proporcional}px`, color: '#495057', border: '1px solid #ced4da'}}
                                        type='default'
                            ...
                            <div style={{width: '100%', height: 50 / proporcional, marginBottom: 16 / proporcional}}>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional}}>
                                   <input 
                                        style={{width: '100%', height: 50 / proporcional, fontSize: 16 / proporcional, lineHeight: `${48 / proporcional}px`, color: '#495057', border: '1px solid #ced4da'}}
                                        type='default'
                                        className='form-control'
                                        value={url}
                            ...
                            <div style={{width: '100%', height: 134 / proporcional, marginBottom: 16 / proporcional}}>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 134 / proporcional}}>
                                   <textarea 
                                        style={{width: '100%', height: 134 / proporcional, fontSize: 16 / proporcional, lineHeight: `${18 / proporcional}px`, color: 'rgb(73, 80, 87', border: '1px solid #ced4da'}}
                                        type='default'
                                        className='form-control'
                                        value={message}
