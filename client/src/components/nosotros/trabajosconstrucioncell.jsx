...
export default function TrabajosConstruccionTablet({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', backgroundImage: `url(${nosotros_fondo})`, backgroundSize: 'cover', backgroundPosition: 'cover', backgroundRepeat: 'no-repeat' }}>
            <div style={{width: '100%', height: 'auto', paddingTop: 80 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
