...
export default function ConoceNuestroEquipoTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom: 40 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto', border: '1px solid rgb(239, 126, 50)', padding: 10 / proporcional}}>
