...
export default function ConstruccionCasasTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 75 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <img src={image_nosotros} style={{width: 400, height: 437 / proporcional}}/>
                </div>
                <div style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '50%', height: 54 / proporcional, marginBottom: 30 / proporcional}}>
