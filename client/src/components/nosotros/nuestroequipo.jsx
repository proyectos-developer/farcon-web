...
export default function ConoceNuestroEquipo({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom: 40 / proporcional, paddingLeft: 320 / proporcional, paddingRight: 320 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '24%', height: 'auto', border: '1px solid rgb(239, 126, 50)', padding: 10 / proporcional}}>
                        <div className='position-relative' style={{width: 278 / proporcional, height: 332 / proporcional, marginBottom: 76 / proporcional}}>
                            <img src={equipo_01} style={{width: 278 / proporcional, height: 332 / proporcional}}/>
                            <div className='position-absolute' style={{width: '100%', height: 'auto', top: 312 / proporcional, left: 81.5 / proporcional}}>
