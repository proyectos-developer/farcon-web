...
export default function ConstruccionCasas({proporcional}) {

    const [botton, setBotton] = useState(false)

    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 75 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 320 / proporcional, paddingRight: 320 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    ...
                    <div style={{width: '50%', height: 'auto'}}>
                        <p style={{fontSize: 24 / proporcional, lineHeight: `${34 / proporcional}px`, marginBottom: 20 / proporcional, fontWeight: 500, color: '#222222'}}>
                        ...
                        <div style={{width: '100%', height: 'auto', marginBottom: 14 / proporcional}}>
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                <div style={{width: '33%', height: 'auto', marginBottom: 15 / proporcional}}>
                        ...
                        <div style={{width: '100%', height: 'auto'}}>
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                ...
                                <div className='d-flex' style={{width: 350 / proporcional, height: 'auto'}}>
