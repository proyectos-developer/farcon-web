...
export default function PorqueNosEligen({proporcional}) {

    const [seleccion_eligen, setSeleccionEligen] = useState ('')

    return (
        <div style={{background: '#f7f7f7', height: 'auto', paddingTop: 80 / proporcional, paddingBottom: 20 / proporcional, paddingLeft: 320 / proporcional, paddingRight: 320 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 46 / proporcional}}>
