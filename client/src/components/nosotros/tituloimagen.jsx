...
export default function TituloImage({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 189 / proporcional, backgroundImage: `url(${nosotros_1920})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
