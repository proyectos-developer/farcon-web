...
export default function PorqueNosEligenTablet({proporcional}) {
    ...
    return (
        <div style={{background: '#f7f7f7', height: 'auto', paddingTop: 80 / proporcional, paddingBottom: 20 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
