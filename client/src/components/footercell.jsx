...
export default function FooterCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional, marginBottom: 25 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional, marginBottom: 25 / proporcional}}>
                ...
                <div style={{width: 429 / proporcional, height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional, marginBottom: 25 / proporcional}}>
                ...
                <div style={{width: 70 / proporcional, marginBottom: 30 / proporcional, height: 1 / proporcional, background: '#ef7e32'}}/>
                <div style={{width: 429 / proporcional, height: 'auto'}}>
                    <div className='d-flex' style={{width: 429 / proporcional, height: 'auto'}}>
                        <img src={icono_location} style={{width: 24 / proporcional, height: 24 / proporcional, marginRight: 38 / proporcional}}/>
                        <div style={{width: 367 / proporcional, lineHeight: 43 / proporcional}}>
                            ...
                            <div style={{width: 367 / proporcional, height: 1, background: 'rgba(255,255,255,0.10)', marginBottom: 14 / proporcional}}/>
                        </div>
                    </div>
                    <div className='d-flex' style={{width: 429 / proporcional, height: 'auto'}}>
                        <img src={icono_phone} style={{width: 24 / proporcional, height: 24 / proporcional, marginRight: 38 / proporcional}}/>
                        <div style={{width: 367 / proporcional, lineHeight: 55 / proporcional}}>
