...
export default function ExperienciaTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', paddingRight: 60 / proporcional, paddingLeft: 60 / proporcional, paddingTop: 40 / proporcional, height: 'auto',
            ...
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: 'auto', height: 'auto', marginBottom: 40 / proporcional}}>
                    <img src={image_experiencia} style={{width: 625 / proporcional, height: 625 / proporcional}}/>
                </div>
                <div style={{width: 871 / proporcional, height: 'auto'}}>
                    ...
                    <div className='d-flex justify-content-between' style={{width: 871 / proporcional, height: 48 / proporcional, marginBottom: 30 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-between' style={{width: 871 / proporcional, height: 50 / proporcional, marginBottom: 30 / proporcional}}>
