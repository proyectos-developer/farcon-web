...
export default function Menciones({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingRight: 350 / proporcional, paddingLeft: 350 / proporcional, paddingTop: 70 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 100 / proporcional, paddingRight: 100 / proporcional, marginBottom: 25 / proporcional}}>
                ...
                <div style={{width: '100%', height: 140 / proporcional, paddingTop: 40 / proporcional, paddingBottom: 40 / proporcional,
