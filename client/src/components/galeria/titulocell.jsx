...
export default function TituloImagen({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 300 / proporcional, backgroundImage: `url(${galeria_1920})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
