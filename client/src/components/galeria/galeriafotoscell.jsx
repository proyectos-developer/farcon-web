...
export default function GaleriaFotos({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
                <div className='position-relative' style={{width: '90%', marginLeft: '5%', marginRight: '5%', marginBottom: 16 / proporcional, height: 340 / proporcional, border: '2px solid #efefef'}}>
