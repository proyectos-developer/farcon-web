...
export default function TituloImageCell({proporcional}) {

    return (
        <div className='position-relative' style={{width: '100%', height: 400 / proporcional, backgroundImage: `url(${fondo_contacto})`, backgroundPosition: 'center', 
