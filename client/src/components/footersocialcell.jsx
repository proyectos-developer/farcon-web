...
export default function FooterSocialCell({proporcional}) {

    return (
        <div className='' style={{width: '100%', paddingRight: 20 / proporcional, paddingLeft: 20 / proporcional, paddingTop: 22 / proporcional, 
